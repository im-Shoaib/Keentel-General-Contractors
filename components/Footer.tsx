        ...
        <div className="sec10-main-footer__inner">
          ...
          <div className="sec10-footer-col">
            ...
            <div className="sec10-footer-badge">
              <span className="sec10-footer-badge__bbb1"><img src="https://lirp.cdn-website.com/1253891b/dms3rep/multi/opt/zeeshan+new+logo+2-168w.png" alt="BBB Accredited Business" /></span>
              
            </div>
            <div className="sec10-footer-social">
              {/* Facebook */}
              <a href="https://www.facebook.com/keentelengineering" className="sec10-footer-social__link" aria-label="Facebook">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@KeentelEngineering" className="sec10-footer-social__link" aria-label="YouTube">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.376.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.376-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/keentel-engineering/" className="sec10-footer-social__link" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
          ...
          <div className="sec10-footer-col">
            ...
            <ul className="sec10-footer-contact">
              ...
              <li className="sec10-footer-contact__item">
                ...
                <span>400 North Ashley Drive  <br/>  Suite 2600, Tampa, FL 33602</span>
              </li>
