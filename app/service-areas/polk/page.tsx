...
export default function PolkPage() {
 ...
 useEffect(() => {
  ...
  const faqs = [
    {
      q: "Q: Do you build on lakefront properties in Polk County?",
      a: "Yes. We are experienced in lakefront construction across Polk County — including setback compliance, environmental permit coordination with the Southwest Florida Water Management District, and dock and seawall scope where applicable.",
    },
    {
      q: "Q: Do you handle commercial and industrial projects in the Lakeland corridor?",
      a: "Yes. We deliver commercial and industrial construction projects along the I-4, US-27, and Polk Parkway corridors — including warehouse, distribution, and logistics facility construction.",
    },
    {
      q: "Q: How do you manage Polk County building permits?",
      a: "We manage all permit applications, plan reviews, and inspections through the Polk County Building Department for every project we deliver in the county.",
    },
    {
      q: "Q: Do you offer emergency response across Polk County?",
      a: "Yes. Our 24/7 emergency response covers all of Polk County. We confirm on-site arrival within 30 to 60 minutes for storm, flood, fire, and structural emergencies.",
    },
    {
      q: "Q: Is your estimate free for Polk County projects?",
  ...
  return (
    <>
      ...
      <div className="tampa-top-label">
        <span>General Contractor — Polk County</span>
        <span className="tampa-divider-label">|</span>
        <span>Residential, Commercial &amp; Industrial Construction — Polk County, Florida</span>
      </div>
      ...
      <section className="tampa-hero" aria-labelledby="hero-heading">
        <div className="tampa-hero-inner">
          ...
          <h1 id="hero-heading" className="tampa-hero-heading tampa-animate-on-scroll tampa-fade-in-up">
            General Contractor in Polk County, Florida
          </h1>
          <p
            className="tampa-hero-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.1s" }}
          >
            We deliver licensed general contracting services across Polk County — from
            Lakeland and Winter Haven to Bartow, Haines City, and Lake Wales. Polk
            County's construction market spans a wide range of project types — from
            residential subdivisions and rural custom homes to large-scale commercial
            and industrial facilities along the I-4 and US-27 corridors.
          </p>
          <p
            className="tampa-hero-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.2s" }}
          >
            We have completed residential builds, commercial construction, industrial
            electrical work, and emergency restoration projects across Polk County. We
            understand the county's specific building standards, its lake-front
            construction requirements — relevant on hundreds of Polk County lakefront
            properties — and the commercial development environment along its major
      ...
      <section className="tampa-section tampa-section-alt" aria-labelledby="services-heading">
        <div className="tampa-section-inner">
          <p className="tampa-section-label">SERVICES WE DELIVER IN POLK COUNTY</p>
          <h2
            id="services-heading"
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            What We Build in Polk County
          </h2>
          <p
          ...
          >
            ...
            Polk County — the same team, the same licensed standard, and the same
      ...
      <section className="tampa-section" aria-labelledby="local-heading">
        <div className="tampa-section-inner tampa-local-heading-center">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Why Local Knowledge Matters in Polk County
          </h2>
          <p
            className="tampa-local-knowledge-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.1s" }}
          >
            Polk County's construction environment is shaped by its size, its diversity
            of land use, and its position as one of Florida's most active logistics and
            distribution hubs. We understand the Polk County Building Department's
            permit requirements for both residential and commercial scopes, the
            lakefront construction setbacks and environmental permit requirements that
            apply to the county's extensive chain of lakes, the agricultural land
            conversion considerations for rural lot development, and the large-footprint
            industrial and warehouse construction standards along the I-4 and Polk
            Parkway corridors.
          </p>
          <h3
            className="tampa-animate-on-scroll tampa-fade-in"
          ...
          >
            Cities &amp; Communities We Serve in Polk County
          </h3>
          <ul
      ...
      <section className="tampa-section tampa-section-alt" aria-labelledby="why-heading">
        <div className="tampa-section-inner">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Why Polk County Clients Choose Keentel
          </h2>
          <div className="tampa-why-grid">
            <div className="tampa-why-card tampa-animate-on-scroll tampa-slide-in-left">
              ...
              <p className="tampa-why-card-desc">
                ...
                Polk County project is fully covered — general liability and workers'
                compensation.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="tampa-why-card-desc">
                ...
                Polk County Building Department on your behalf. You never have to
                chase approvals.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="tampa-why-card-desc">
                Every project we complete in Polk County is backed by our written
      ...
      <section className="tampa-cta-section" aria-labelledby="cta-heading">
        <div className="tampa-cta-inner">
          ...
          >
            Start Your Polk County Project Today
          </h2>
          <p
            className="tampa-animate-on-scroll tampa-fade-in"
            style={{
          ...
          >
            ...
            your residential, commercial, or industrial project anywhere in Polk
            County.
          </p>
          <div
          ...
          >
            <i className="fa-solid fa-location-dot"></i> &nbsp;Serving all of Polk
            County, Florida
          </p>
        </div>
      </section>
