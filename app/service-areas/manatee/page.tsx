...
export default function ManateePage() {
  ...
  const faqs = [
    {
      q: "Q: Do you build on Anna Maria Island and other coastal areas in Manatee County?",
      a: "Yes. We are experienced in coastal construction across Manatee County — including Anna Maria Island, Bradenton Beach, and waterfront properties along the Manatee River — where coastal construction setbacks, flood zone compliance, and wind-borne debris standards apply.",
    },
    {
      q: "Q: Do you work in the Lakewood Ranch area?",
      a: "Yes. We deliver new residential construction, remodeling, and commercial projects in Lakewood Ranch and across the Manatee County growth corridor. We are familiar with Lakewood Ranch's community development standards and HOA requirements.",
    },
    {
      q: "Q: How do you manage Manatee County building permits?",
      a: "We manage all permit applications, plan reviews, and inspections through the Manatee County Building Department for every project we deliver in the county.",
    },
    {
      q: "Q: Do you provide 24/7 emergency response in Manatee County?",
      a: "Yes. Our emergency response covers all of Manatee County. We confirm on-site arrival within 30 to 60 minutes for storm, flood, fire, and structural emergencies.",
    },
    {
      q: "Q: Is your estimate free for Manatee County projects?",
  ...
  return (
    <>
      ...
      <div className="tampa-top-label">
        <span>General Contractor — Manatee County</span>
        <span className="tampa-divider-label">|</span>
        <span>Residential, Commercial &amp; Industrial Construction — Manatee County, Florida</span>
      </div>
      ...
      <section className="tampa-hero" aria-labelledby="hero-heading">
        <div className="tampa-hero-inner">
          ...
          <h1 id="hero-heading" className="tampa-hero-heading tampa-animate-on-scroll tampa-fade-in-up">
            General Contractor in Manatee County, Florida
          </h1>
          <p
            className="tampa-hero-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.1s" }}
          >
            We deliver licensed general contracting services across Manatee County — from
            Bradenton and Anna Maria Island to Lakewood Ranch and Palmetto. Manatee
            County's construction market spans some of Florida's most desirable coastal
            properties alongside rapidly growing inland communities, and we have the
            experience to navigate both environments effectively.
          </p>
          <p
            className="tampa-hero-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.2s" }}
          >
            We have completed residential builds, commercial projects, and emergency
            restoration work throughout Manatee County. We understand the county's
            specific building standards, its coastal construction requirements along
            the Gulf shoreline, and the high-growth development environment in the
      ...
      <section className="tampa-section tampa-section-alt" aria-labelledby="services-heading">
        <div className="tampa-section-inner">
          <p className="tampa-section-label">SERVICES WE DELIVER IN MANATEE COUNTY</p>
          <h2
            id="services-heading"
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            What We Build in Manatee County
          </h2>
          <p
          ...
          >
            ...
            Manatee County — the same team, the same licensed standard, and the same
      ...
      <section className="tampa-section" aria-labelledby="local-heading">
        <div className="tampa-section-inner tampa-local-heading-center">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Why Local Knowledge Matters in Manatee County
          </h2>
          <p
            className="tampa-local-knowledge-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.1s" }}
          >
            Manatee County's construction environment spans two distinct zones — the
            coastal properties along Anna Maria Island, Longboat Key's Manatee portion,
            and the Bradenton waterfront where coastal construction setbacks,
            wind-borne debris requirements, and elevation standards apply strictly —
            and the inland residential and commercial growth corridor around Lakewood
            Ranch and Parrish where new development volume is high. We understand both
            zones and the Manatee County Building Department's specific requirements
            for each.
          </p>
          <h3
            className="tampa-animate-on-scroll tampa-fade-in"
          ...
          >
            Cities &amp; Communities We Serve in Manatee County
          </h3>
          <ul
      ...
      <section className="tampa-section tampa-section-alt" aria-labelledby="why-heading">
        <div className="tampa-section-inner">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Why Manatee County Clients Choose Keentel
          </h2>
          <div className="tampa-why-grid">
            <div className="tampa-why-card tampa-animate-on-scroll tampa-slide-in-left">
              ...
              <p className="tampa-why-card-desc">
                ...
                Manatee County project is fully covered — general liability and
            ...
            >
              ...
              <p className="tampa-why-card-desc">
                ...
                Manatee County Building Department on your behalf. You never have to
                chase approvals.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="tampa-why-card-desc">
                Every project we complete in Manatee County is backed by our written
      ...
      <section className="tampa-section" aria-labelledby="faq-heading">
        <div className="tampa-section-inner">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Frequently Asked Questions — Manatee County
          </h2>
      ...
      <section className="tampa-cta-section" aria-labelledby="cta-heading">
        <div className="tampa-cta-inner">
          ...
          >
            Start Your Manatee County Project Today
          </h2>
          <p
            className="tampa-animate-on-scroll tampa-fade-in"
            style={{
          ...
          >
            ...
            your residential, commercial, or industrial project anywhere in Manatee
            County.
          </p>
          <div
          ...
          >
            <i className="fa-solid fa-location-dot"></i> &nbsp;Serving all of Manatee
            County, Florida
          </p>
        </div>
      </section>
