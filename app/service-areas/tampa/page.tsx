...
export default function TampaPage() {
  ...
  useEffect(() => {
    ...
    // Counter animation for 158+ stat
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting && !countUpDone && countUpTarget) {
            ...
            const target = parseInt(targetElement.getAttribute("data-count") || "158");
            const duration = 1800;
      ...
      >
        ...
        <div className="tampa-hero-inner">
          <h1 id="hero-heading" className="tampa-hero-heading tampa-animate-on-scroll tampa-fade-in-up">
            General Contractor in Tampa, Florida
          </h1>
          <p className="tampa-hero-text tampa-animate-on-scroll tampa-fade-in-up" style={{ transitionDelay: "0.1s" }}>
            ...
            and industrial construction projects throughout the city for over two decades.
            Tampa's construction market moves fast — permitting timelines, code enforcement,
            and local subcontractor availability all require a contractor who knows the
            territory. We do.
          </p>
          <p className="tampa-hero-text tampa-animate-on-scroll tampa-fade-in-up" style={{ transitionDelay: "0.15s" }}>
            Whether you are building a custom home in South Tampa, fitting out a commercial
            space in downtown, managing an industrial expansion near the Port of Tampa,
            or dealing with a storm emergency overnight — our licensed team is the one
            call that covers every scope.
          </p>
        ...
        <div className="tampa-stats-bar-inner">
          ...
          >
            <div className="tampa-stat-value">
              <span className="tampa-count-up-target" data-count="158">
                158
              </span>
              +
            </div>
        ...
        <div className="tampa-section-inner tampa-local-split">
          <div className="tampa-local-text tampa-animate-on-scroll tampa-slide-in-left">
            ...
            <p className="tampa-local-description">
              ...
              preferences, and inspection sequencing — and we navigate it daily.
            </p>
            <p className="tampa-local-description">
              We also understand Tampa's neighborhood‑specific HOA requirements, historic
      ...
      <section className="tampa-cta-light" aria-labelledby="cta-heading">
        <div className="tampa-cta-light-inner">
          ...
          <p className="tampa-cta-light-text tampa-animate-on-scroll tampa-fade-in" style={{ transitionDelay: "0.1s" }}>
            ...
            or industrial project anywhere in Tampa County.
          </p>
          ...
          <p className="tampa-cta-light-location tampa-animate-on-scroll tampa-fade-in" style={{ transitionDelay: "0.45s" }}>
            <i className="fa-solid fa-location-dot"></i> Serving all of Tampa County, Florida
          </p>
        </div>
      </section>
    </>
