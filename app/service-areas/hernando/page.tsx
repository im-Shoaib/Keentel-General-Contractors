...
export default function HernandoPage() {
  ...
  const faqs = [
    {
      q: "Q: Do you manage permits through the Hernando County Building Department?",
      a: "Yes. We manage all permit applications, plan reviews, and inspections through the Hernando County Building Department for every project we deliver in the county.",
    },
    {
      q: "Q: Can you build in Spring Hill's newer residential developments?",
      a: "Yes. We deliver new residential construction, additions, and remodeling projects throughout Spring Hill and across all Hernando County communities.",
    },
    {
      q: "Q: How do you handle wetland setbacks on Hernando County lots?",
      a: "We conduct a site assessment before finalizing any project plan on lots where wetland buffers may apply. We coordinate with the relevant county and state agencies and design the project footprint to respect all required setbacks.",
    },
    {
      q: "Q: Do you respond to emergencies in Hernando County?",
      a: "Yes. Our 24/7 emergency response covers all of Hernando County. We confirm on-site arrival within 30 to 60 minutes for storm, flood, and structural emergencies across the county.",
    },
    {
      q: "Q: Is your estimate free for Hernando County projects?",
  ...
  return (
    <>
      ...
      <div className="tampa-top-label">
        <span>General Contractor — Hernando County</span>
        <span className="tampa-divider-label">|</span>
        <span>Residential, Commercial &amp; Industrial Construction — Hernando County, Florida</span>
      </div>
      ...
      <section className="tampa-hero" aria-labelledby="hero-heading">
        <div className="tampa-hero-inner">
          ...
          <h1 id="hero-heading" className="tampa-hero-heading tampa-animate-on-scroll tampa-fade-in-up">
            General Contractor in Hernando County, Florida
          </h1>
          <p
            className="tampa-hero-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.1s" }}
          >
            We deliver licensed general contracting services across Hernando County — from
            Brooksville and Spring Hill to Weeki Wachee and every growing community in the
            region. Hernando County is one of Florida's fastest-growing construction
            markets and we have been active in it long enough to understand what drives
          ...
          >
            We always advise Hernando County clients that the county's rapid growth has
            created significant variation in permit processing timelines and inspection
            demand. Working with a contractor who manages that process actively — rather
            than leaving it to the client — makes a measurable difference in project
            delivery.
          </p>
        </div>
      </section>
      ...
      <section className="tampa-section tampa-section-alt" aria-labelledby="services-heading">
        <div className="tampa-section-inner">
          <p className="tampa-section-label">SERVICES WE DELIVER IN HERNANDO COUNTY</p>
          <h2
            id="services-heading"
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            What We Build in Hernando County
          </h2>
          <p
          ...
          >
            ...
            Hernando County — the same team, the same licensed standard, and the same
      ...
      <section className="tampa-section" aria-labelledby="local-heading">
        <div className="tampa-section-inner tampa-local-heading-center">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Why Local Knowledge Matters in Hernando County
          </h2>
          <p
            className="tampa-local-knowledge-text tampa-animate-on-scroll tampa-fade-in-up"
            style={{ transitionDelay: "0.1s" }}
          >
            Hernando County's construction environment is shaped by its rapid
            residential growth, its mix of established Brooksville neighborhoods and
            new Spring Hill developments, and a building department managing high
            permit volume. We understand the county's specific requirements for new
            residential construction on the area's predominant sandy soil conditions,
            the wetland setback requirements that affect many Hernando County lots,
            and the commercial construction standards in the Brooksville and Spring
            Hill commercial corridors.
          </p>
          <h3
            className="tampa-animate-on-scroll tampa-fade-in"
            style={{
          ...
          >
            Cities &amp; Communities We Serve in Hernando County
          </h3>
          <ul
      ...
      <section className="tampa-section tampa-section-alt" aria-labelledby="why-heading">
        <div className="tampa-section-inner">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Why Hernando County Clients Choose Keentel
          </h2>
          <div className="tampa-why-grid">
            <div className="tampa-why-card tampa-animate-on-scroll tampa-slide-in-left">
              ...
              <p className="tampa-why-card-desc">
                ...
                Hernando County project is fully covered — general liability and
            ...
            >
              ...
              <p className="tampa-why-card-desc">
                ...
                Hernando County Building Department on your behalf. You never have to
                chase approvals.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="tampa-why-card-desc">
                Every project we complete in Hernando County is backed by our written
      ...
      <section className="tampa-section" aria-labelledby="faq-heading">
        <div className="tampa-section-inner">
          ...
          <h2
            ...
            className="tampa-section-heading tampa-animate-on-scroll tampa-fade-in-up"
          >
            Frequently Asked Questions — Hernando County
          </h2>
      ...
      <section className="tampa-cta-section" aria-labelledby="cta-heading">
        <div className="tampa-cta-inner">
          ...
          >
            Start Your Hernando County Project Today
          </h2>
          <p
            className="tampa-animate-on-scroll tampa-fade-in"
            style={{
          ...
          >
            ...
            your residential, commercial, or industrial project anywhere in Hernando
            County.
          </p>
          <div
          ...
          >
            <i className="fa-solid fa-location-dot"></i> &nbsp;Serving all of Hernando
            County, Florida
          </p>
        </div>
      </section>
