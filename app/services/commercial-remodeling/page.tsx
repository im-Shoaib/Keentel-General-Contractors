          ...
          <div className="crs-contact-grid">
            <form className="crs-contact-form crs-reveal crs-reveal-delay-2" ref={formRef} onSubmit={handleFormSubmit}>
              <div className="crs-form-row">
                <input type="text" className="crs-form-input" placeholder="Full Name *" required />
                <input type="text" className="crs-form-input" placeholder="Company" />
              </div>
              <div className="crs-form-row">
                <input type="email" className="crs-form-input" placeholder="Email Address *" required />
                <input type="tel" className="crs-form-input" placeholder="Phone Number" />
              </div>
              <div className="crs-form-row">
                <input type="text" className="crs-form-input" placeholder="Property Location" />
              ...
              <textarea className="crs-form-textarea" placeholder="Tell Us About Your Remodeling Project *" required></textarea>
